...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/opt/nginx/html/automobile/vendor/ruby/2.0.0/gems/nokogiri-1.6.0/ports/i686-linux-gnu/libxslt/1.1.26/lib/libxslt-plugins"
#endif
